...
import {
    Users, GraduationCap, School, ArrowLeft, Sparkles,
...
export default function PortalPage() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/40 to-indigo-50/60 overflow-x-hidden">
            {/* Decorative blobs */}
            <div className="fixed inset-0 pointer-events-none overflow-hidden">
                ...
                <motion.div
                    ...
                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full bg-violet-100/25 blur-3xl"
                />
            </div>
            ...
            <div className="relative z-10 flex flex-col min-h-screen">
                ...
                <div className="px-4 sm:px-8 pt-6 pb-2 flex items-center justify-between">
                    <Link href="/" className="inline-flex items-center gap-2 text-sm text-slate-500 hover:text-blue-700 font-semibold transition-colors group">
                        <motion.span whileHover={{ x: -3 }} className="inline-flex">
                            <ArrowLeft className="w-4 h-4" />
                        </motion.span>
                        Back to School Website
                    </Link>
                    <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/80 border border-blue-100 shadow-sm backdrop-blur-sm">
                        <div className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                        <span className="text-xs font-bold text-slate-600">Secure Login</span>
                    </div>
                </div>
                ...
                <div className="flex-1 flex flex-col items-center justify-center px-4 sm:px-6 py-12">
                    ...
                    >
                        <div className="relative w-12 h-12 rounded-2xl overflow-hidden border-2 border-white shadow-md">
                            <Image src="/school-logo.png" alt="Sunrise International School" fill className="object-contain p-1" />
                        </div>
                        <div>
                            <p className="text-sm font-black text-slate-800">Sunrise International School</p>
                            <p className="text-[10px] text-slate-500 uppercase tracking-widest">CBSE Affiliated · Est. 2001 · New Delhi</p>
                        </div>
                    </motion.div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="relative z-10 flex flex-col h-full">
                                        ...
                                        {/* Title & tagline */}
                                        <h2 className="text-2xl font-black text-slate-900 mb-1">{portal.title}</h2>
                                        ...
                                        <ul className="space-y-2 mb-7">
                                            {portal.features.map((f, fi) => (
                                                <motion.li
                                                    ...
                                                    transition={{ delay: 0.5 + i * 0.12 + fi * 0.05 }}
                    ...
                    <motion.div
                        ...
                        className="flex flex-wrap items-center gap-4 mt-10 justify-center"
                    >
                        {[
                    ...
                    >
                        School ERP Platform by{" "}
                        <a href="http://localhost:3002" target="_blank" rel="noreferrer" className="text-blue-500 hover:text-blue-600 transition-colors font-bold">
                            Amrit Tech Solution
                        </a>
